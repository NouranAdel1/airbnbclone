      ...
      if (_formKey.currentState!.validate()) {
        ...
        await _auth.fetchSignInMethodsForEmail(email).then((methods) {
          if (methods.isNotEmpty) {
            ...
            _auth.createUserWithEmailAndPassword(email: email, password: password).then((userCredential) {
              // After successful sign-up, update user provider
              Provider.of<UserProvider>(context, listen: false).user = userCredential.user;
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child: const Text('Log in', style: TextStyle(color: Colors.red, fontSize: 16)),
                  ),
                ],
              ),
            ],
